...
%      applied to the GUI before mask_OpeningFcn gets called.  An
...
% Edit the above text to modify the response to help mask

% Last Modified by GUIDE v2.5 23-Jan-2014 21:28:57
...
%Finish button which set the value of the mask parameters
